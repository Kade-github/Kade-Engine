...
class Debug
{
	...
	{
		// Example: This will display player's sprite properties in a debug window.
		addConsoleCommand("trackPlayer", function()
		{
			Debug.logInfo("CONSOLE: Begin tracking Player...");
			trackObject(PlayState.player);
		});
		...
		addConsoleCommand("trackOpponent", function()
		{
			Debug.logInfo("CONSOLE: Begin tracking Opponent...");
			trackObject(PlayState.opponent);
		});
